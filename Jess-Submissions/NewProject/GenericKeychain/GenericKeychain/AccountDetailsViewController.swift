...
class AccountDetailsViewController: UITableViewController {
    ...
    @IBAction func save(_ sender: AnyObject) {
        ...
        guard let newAccountName = accountNameField.text, newPassword = passwordField.text where !newAccountName.isEmpty && !newPassword.isEmpty else { return }
    ...
    func updateSaveButtonState() {
        ...
        if let newAccount = accountNameField.text, newPassword = passwordField.text where !newAccount.isEmpty && !newPassword.isEmpty {
